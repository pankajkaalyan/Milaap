  ...
  return (
    <div className="flex items-center gap-1 sm:gap-2 w-full">
      ...
      <input
        ...
        className="flex-1 px-3 py-2 sm:px-4 sm:py-2 bg-gray-700 border border-gray-600 
               rounded-full focus:outline-none focus:ring-2 focus:ring-amber-500 
               text-white disabled:opacity-50 text-sm sm:text-base"
      ...
      <button
        onClick={handleSend}
        className="p-1 sm:p-2 text-white bg-gradient-to-r from-amber-500 to-orange-600 
