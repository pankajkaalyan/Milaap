...
const FileUpload: React.FC<FileUploadProps> = ({
  ...
  return (
    <div>
      ...
      <div
        className="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-600 border-dashed rounded-md cursor-pointer hover:border-amber-500 transition-colors"
        onClick={handleWrapperClick} // Entire area clickable
        onDrop={handleDrop}           // Enable dropping files
        onDragOver={handleDragOver}   // Enable drop area
      >
        <div className="space-y-1 text-center">
          ...
          <div className="flex text-sm text-gray-400 justify-center">
            <span className="relative bg-transparent rounded-md font-medium text-amber-400 hover:text-amber-300">
              Upload a file
              <input
                id={id}
                name={id}
