...
import { SpinnerSize, ButtonVariant } from '../../types';
...
const Verification: React.FC = () => {
  ...
  const status = user?.profile?.verificationStatus || 'Not Verified';
  ...
  const handleSubmit = () => {
    ...
    submitVerification();
    addToast(t('toast.verification.submitted'), 'success');
  };
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <Card>
        ...
        <div className="mt-6">
            <div className="mb-6">
                <h2 className="text-lg font-semibold text-white">{t('verification.status')}: 
                    <span className={`ml-2 ${
